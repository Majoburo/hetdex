...
def rotatecrop(hdu):
    ...
    c=SkyCoord(205.60811706,28.41213802, unit="deg")
    ...
    if args.basename is None:
        ...
        if not filenames:
            ...
            for i in xrange(len(filenames)):
                args.fitsfiles = pyfits.open(filenames[i])
...
def main():
    ...
    for fitsfile in fitsfiles:#for now just doing one ifu
        ...
        fitsfile.writeto('imaging/cube.fits',clobber =True)
   ...
   # hdu.writeto('imaging/imgcut.fits',clobber =True)
    ...
    print 'THE IFU IS CENTERED AT:'
    print ra,dec
    print 'The offset is:'
    print(ra-205.60811706,dec-28.41213802)
    '''
    #Plotting
    ...
    for j in range(124):
        ...
        hdu.data[y+j-124/2,x-124/2]=0
    hdu.writeto('imaging/GBsdssDR12g.fits',clobber =True)
